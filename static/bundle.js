...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _page2.default)('/', _routes2.default.home);
	(0, _page2.default)('/about', _routes2.default.about);
	(0, _page2.default)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tweets = __webpack_require__(30);
	...
	var _tweets3 = __webpack_require__(32);
	
	var _tweets4 = _interopRequireDefault(_tweets3);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var loading = function loading() {
	  return (0, _jquery2.default)('#tweets').html((0, _loading2.default)());
	};
	var renderList = function renderList(tweets) {
	  return (0, _jquery2.default)('#tweets').html((0, _tweets2.default)(tweets));
	};
	
	var initializeHome = function initializeHome() {
	  (0, _jquery2.default)('#search').submit(function (e) {
	    e.preventDefault();
	    loading();
	    (0, _tweets4.default)((0, _jquery2.default)('#search-input').val()).then(function (tweets) {
	      return renderList(tweets);
	    });
	  });
	};
	
	var home = function home() {
	  (0, _render2.default)((0, _home2.default)());
	  initializeHome();
	};
...
/***/ function(module, exports) {
	...
	var render = function render(html) {
	  var callback = arguments.length <= 1 || arguments[1] === undefined ? cb : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<h1>Sentiment Analysis of Tweets</h1>\n<form id=\"search\">\n  <input\n    id=\"search-input\"\n    type=\"text\"\n    placeholder=\"Enter twitter search\"\n  />\n</form>\n<div id=\"tweets\" class=\"row\"></div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"col l12\">\n    <div class=\"card blue-grey darken-1\">\n      <div class=\"card-content white-text\">\n        <span class=\"card-title\">\n          <a href=\"http://twitter.com/"
	    ...
	    + "</p>\n        <p>"
	    + alias2(((helper = (helper = helpers.sentiment || (depth0 != null ? depth0.sentiment : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"sentiment","hash":{},"data":data}) : helper)))
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.statuses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search = function search(val) {
	  return (0, _isomorphicFetch2.default)('http://localhost:5000/analyze', {
	    method: 'POST',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var about = function about() {
	  (0, _render2.default)((0, _about2.default)());
	};
